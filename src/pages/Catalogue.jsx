      ...
      <div style={{
        ...
        <div style={{ padding: '22px 26px 30px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <a
              href={`mailto:kavithaglass1967@gmail.com?subject=${encodeURIComponent('Enquiry: ' + product.name + ' (' + selectedSize + ')')}&body=${enquiryBody}`}
              style={{
            ...
            >
              ✉️ Enquire This Product Directly
            </a>
          </div>
      ...
      <div className="product-body">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
          ...
          <a
            ...
            style={{ width: '100%', padding: '7px 14px', borderRadius: 8, border: '1px solid var(--glass-border)', color: 'var(--text-3)', fontSize: '0.74rem', fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5, transition: 'all 0.2s' }}
          >
            ✉️ Enquire This Product
          </a>
        </div>
      </div>
    </div>
